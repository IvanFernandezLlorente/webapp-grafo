<template>
  <div class="body-content">
      <div class="buttons">
        <b-link v-if="canEdit()" class="edit" :to="{path: `/edit/${problem.problemId}`}"> 
...
export default {
    ...
    methods: {
        ...
        async deleteP() {
            const res = await axios.delete(`http://localhost:4000/api/problems/${this.$route.params.problemId}`,{
